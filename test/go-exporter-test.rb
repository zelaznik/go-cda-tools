...
class GoExporterTest < Minitest::Test
  ...
  def test_valid_cat1
    # qrda = GoCDATools::Export::GoExporter.instance.export_with_ffi(File.read('test/fixtures/records/barry_berry.json'), [JSON.parse(File.read('test/fixtures/measures/cms9v4a.json'))].to_json)
