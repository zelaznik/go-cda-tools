...
//line templates/_addresses.ego:1
 func AddressesTmpl(w io.Writer, address *Address) error  {
...
//line templates/_author.ego:1
 func AuthorTmpl(w io.Writer, author *Person) error  {
...
//line templates/_id.ego:1
 func IdTmpl(w io.Writer, identifier *ID) error  {
...
//line templates/_record_target.ego:1
 func RecordTargetTmpl(w io.Writer, patient *Record) error  {
...
_, _ = io.WriteString(w, "\n      ")
//line templates/_record_target.ego:6
 mrn := ID{Root: patient.MedicalRecordNumber, Extension: patient.MedicalRecordAssigner} 
...
//line templates/cat1.ego:1
 func Cat1Tmpl(w io.Writer, patient *Record) error  {
